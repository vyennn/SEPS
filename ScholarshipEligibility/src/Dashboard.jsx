          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px" }}>
            ...
            <tbody>
              {processedBatches.length === 0 ? (
                <tr>
                  <td colSpan="8" style={{ textAlign: "center", padding: "20px" }}>No batches yet. Filter students to create a batch.</td>
                </tr>
              ) : (
                processedBatches.map((batch, idx) => (
                  <tr key={idx} style={{ borderBottom: "1px solid #e5e7eb" }}>
                    ...
                    <td style={{ padding: "10px", color: "#666" }}>{batch.date} {batch.time || ""}</td>
